...
FLATTEN = '/home/dan/code/BISICLES-public/code/filetools/flatten2d.Linux.64.mpiCC.gfortran.DEBUG.MPI.ex'
...
def convert_to_nc(basic_path, var_path):
    fullpath = basic_path + var_path
    
    files = sorted(glob.glob(fullpath + '*.2d.hdf5'))[:]    
    for k,file in enumerate(files):
        print file

        var_nc_name = file.replace('.2d.hdf5','.nc')
        print var_nc_name
    
        os.system('{} {} {} {}'.format( FLATTEN, file, var_nc_name, '0'))
...
# experiment 1,5,9,10,12
#atm_path = 'ismip6_atmos/noresm1-m_rcp8.5/'
# experiment 6
#atm_path = 'ismip6_atmos/miroc-esm-chem_rcp8.5/'
#experiment 7
#atm_path = 'ismip6_atmos/noresm1-m_rcp2.6/'
#experiment 8,12
atm_path = 'ismip6_atmos/ccsm4_rcp8.5/'
...
print 'ocean forcing'
# experiment 1,5,9,10
#ocean_path = 'ismip6_ocean/noresm1-m_rcp8.5/'
# experiment 6
#ocean_path = 'ismip6_ocean/miroc-esm-chem_rcp8.5/'
# experiment 7
#ocean_path = 'ismip6_ocean/noresm1-m_rcp2.6/'
#experiment 8,12
ocean_path = 'ismip6_atmos/ccsm4_rcp8.5/'


#convert_to_nc(path, ocean_path)
...
print 'shelf collapse'
# experiment 12
shelf_mask_path = 'ismip6_shelf/ccsm4_rcp8.5/'

#interp_and_write(xcrse, ycrse, path, shelf_mask_path)
