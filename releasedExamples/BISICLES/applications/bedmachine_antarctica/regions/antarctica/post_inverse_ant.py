...
ctrl =  BisiclesData('inverse/ctrl.ant_bmach_muLT1.03lev.000024000016.2d.hdf5',
...
uf = 150.0
c_third_jreg_150 = c_third * ( ctrl.speed/uf + 1.0 )**(1.0/3.0)
uf = 50.0
c_third_jreg_50 = c_third * ( ctrl.speed/uf + 1.0 )**(1.0/3.0) 
mucoef = ctrl.mucoef

write_ais_nc(ncf, ctrl.x,ctrl.y, {'c_one':c_one, 'c_third':c_third,
                                  'c_third_jreg_300':c_third_jreg_300,
                                  'c_third_jreg_150':c_third_jreg_150,
                                  'c_third_jreg_50':c_third_jreg_50,
                                  'mucoef':mucoef})
nctoamr(ncf,hdf,'c_one c_third  c_third_jreg_300  c_third_jreg_150  c_third_jreg_50 mucoef')
