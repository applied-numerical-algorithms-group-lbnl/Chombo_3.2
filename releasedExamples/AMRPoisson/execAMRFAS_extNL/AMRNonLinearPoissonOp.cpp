                                      ...
                                      bool                        a_homogeneous)
{
  ...
  {
      CH_TIME("AMRNonLinearPoissonOp::residualI::MEMBER_FUNC_PTR");
                                     ...
                                     bool                        a_homogeneous)
{
  ...
  LevelData<FArrayBox>  a_nlDfunc(dbl, 1, IntVect::Zero);
  {
      CH_TIME("AMRNonLinearPoissonOp::applyOpI::MEMBER_FUNC_PTR");
      MEMBER_FUNC_PTR(*m_amrHydro, m_nllevel)(a_nlfunc, a_nlDfunc, a_phi);
  }
                                              ...
                                              const LevelData<FArrayBox>& a_phi)
{
  ...
  LevelData<FArrayBox>  a_nlDfunc(dbl, 1, IntVect::Zero);
  {
      CH_TIME("AMRNonLinearPoissonOp::applyOpNoBoundary::MEMBER_FUNC_PTR");
      MEMBER_FUNC_PTR(*m_amrHydro, m_nllevel)(a_nlfunc, a_nlDfunc, a_phi);
  }
                                             ...
                                             bool homogeneous)
{
  ...
  {
      CH_TIME("AMRNonLinearPoissonOp::restrictResidual::MEMBER_FUNC_PTR");
                                       ...
                                       int                         a_depth )
{
  ...
  LevelData<FArrayBox>  a_nlDfunc(dbl, 1, IntVect::Zero);
  {
      CH_TIME("AMRNonLinearPoissonOp::levelGSRB::MEMBER_FUNC_PTR");
      MEMBER_FUNC_PTR(*m_amrHydro, m_nllevel)(a_nlfunc, a_nlDfunc, a_phi);
  }
                                     ...
                                     const LevelData<FArrayBox>& a_rhs )
{
  ...
  LevelData<FArrayBox>  a_nlDfunc(dbl, 1, IntVect::Zero);
  {
      CH_TIME("AMRNonLinearPoissonOp::levelGS::MEMBER_FUNC_PTR");
      MEMBER_FUNC_PTR(*m_amrHydro, m_nllevel)(a_nlfunc, a_nlDfunc, a_phi);
  }
                                          ...
                                          Real                     a_beta)
{
  ...
  define(a_domain, grids, refRatio, a_dx, a_bc, 
         amrHydro, nllevel, a_alpha, a_beta);
}
