...
BoxLayout::BoxLayout(const Vector<Box>& a_boxes, const Vector<int>& a_assignments
#ifdef CH_MPI            
          ,MPI_Comm          a_comm
#endif            
  )
{
  define(a_boxes, a_assignments
#ifdef CH_MPI         
        ,a_comm
#endif         
    );
...
void
BoxLayout::define(const Vector<Box>& a_boxes, const Vector<int>& a_procs
#ifdef CH_MPI            
       ,MPI_Comm          a_comm
#endif            
  )
